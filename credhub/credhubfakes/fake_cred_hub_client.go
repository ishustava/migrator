...
type FakeCredHubClient struct {
	SetPasswordStub        func(name string, value values.Password, overwrite bool) (credentials.Password, error)
	...
	SetCertificateStub        func(name string, value values.Certificate, overwrite bool) (credentials.Certificate, error)
	...
	SetRSAStub        func(name string, value values.RSA, overwrite bool) (credentials.RSA, error)
	...
	SetSSHStub        func(name string, value values.SSH, overwrite bool) (credentials.SSH, error)
...
func (fake *FakeCredHubClient) SetPassword(name string, value values.Password, overwrite bool) (credentials.Password, error) {
...
func (fake *FakeCredHubClient) SetPasswordArgsForCall(i int) (string, values.Password, bool) {
	fake.setPasswordMutex.RLock()
	defer fake.setPasswordMutex.RUnlock()
...
func (fake *FakeCredHubClient) SetCertificate(name string, value values.Certificate, overwrite bool) (credentials.Certificate, error) {
...
func (fake *FakeCredHubClient) SetCertificateArgsForCall(i int) (string, values.Certificate, bool) {
	fake.setCertificateMutex.RLock()
	defer fake.setCertificateMutex.RUnlock()
...
func (fake *FakeCredHubClient) SetRSA(name string, value values.RSA, overwrite bool) (credentials.RSA, error) {
...
func (fake *FakeCredHubClient) SetRSAArgsForCall(i int) (string, values.RSA, bool) {
	fake.setRSAMutex.RLock()
	defer fake.setRSAMutex.RUnlock()
...
func (fake *FakeCredHubClient) SetSSH(name string, value values.SSH, overwrite bool) (credentials.SSH, error) {
...
func (fake *FakeCredHubClient) SetSSHArgsForCall(i int) (string, values.SSH, bool) {
	fake.setSSHMutex.RLock()
	defer fake.setSSHMutex.RUnlock()
