...
type MigrateCommand struct {
	...
	DirectorName        string   `long:"director-name" description:"Name of the BOSH director"`
	DeploymentName      string   `long:"deployment-name" description:"Name of the BOSH deployment with which vars store is used"`
